...
const (
	...
	ErrGitClone                     = "cannot clone the git repository %q due to error: %s. output: %s"
	ErrGitFetch                     = "cannot fetch repository references for %s: %s. output: %s"
	...
	ErrGitPush                      = "cannot git push to '%s' due to %s. output:%s"
