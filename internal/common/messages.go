...
const (
	...
	ErrRepoList                     = "cannot fetch repositories due to error :%w"
	...
	ErrListBranchRules              = "cannot list branch rules for repository %s: %v"
	ErrListBranchRulesets           = "cannot list branch rulesets for repo %s: %v"
	ErrFetchBranchRuleset           = "cannot fetch branch ruleset %d for repo %s: %v"
